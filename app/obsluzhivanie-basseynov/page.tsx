...
export const metadata: Metadata = {
  ...
  description:
    "Обслуживание и чистка бассейнов в Сочи: цена по запросу. Рассчитаем стоимость за 15 мин. Прайс, договор, гарантия. Закажите расчёт →",
  keywords: [
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-3 text-lg text-[var(--muted)]">
        Комплексное сервисное обслуживание бассейнов: чистка, контроль воды,
        обслуживание оборудования. Работаем по договору с понятным регламентом и
        фиксированной стоимостью в месяц.
      </p>
      ...
      <section className="mt-10">
        ...
        <ul className="mt-4 space-y-2 text-[var(--muted)]">
          <li>
            — Контроль и корректировка качества воды (водоподготовка без хлора)
          </li>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 text-[var(--muted)]">
          Цена зависит от объёма бассейна и количества выездов в месяц. Ниже —
          ориентировочный прайс. Точную стоимость обслуживания бассейна
          рассчитаем после осмотра или по калькулятору.
        </p>
        <div className="mt-4">
          <PriceTable />
        </div>
      ...
      <section className="mt-10">
        ...
        <p className="mt-2 text-[var(--muted)]">
          Заключаем договор на обслуживание бассейна с чётким регламентом работ
          и нормативами. Специалисты по обслуживанию плавательного бассейна
          выезжают по графику. Помещения обслуживания бассейна (технический
          узел) проверяем при каждом визите.
        </p>
      </section>
