...
export const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Проверка воды, корректировка химии, чистка чаши и ватерлинии, уборка пылесосом, обслуживание фильтров и рекомендации по дальнейшей эксплуатации.",
  },
] as const;
...
export const servicePages: Record<ServiceSlug, ServicePageData> = {
  ...
  "remont-basseynov": {
    ...
    h1: "Ремонт бассейнов в Сочи: всё, что нужно знать владельцу",
    metaTitle: "Ремонт бассейнов в Сочи — услуги по ремонту чаши, оборудования, гидроизоляция. Гарантия до 2 лет. Срочный выезд мастера!",
    description:
      "Профессиональный ремонт бассейнов в Сочи и Адлере: ремонт чаши, насосов, фильтров, систем подогрева. Гарантия до 2 лет. Выезд инженера за 24 часа. Прозрачные цены от 2000 ₽. Работаем с отелями и частными клиентами.",
    heroDescription:
